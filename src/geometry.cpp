#include "geometry.h"
// xplicit templtae specs for vector type converstin
// handles rounding wen converting float->int and vice versa
template <>
template <>
// why is it formatted like this, anyways we are rounding to nearest integer
